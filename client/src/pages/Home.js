...
function Home() {
  ...
  const { setActiveMenu, setShowNavBar, showModal, setShowModal, setIsSignUp, isOpenMenu, setIsOpenMenu, currentColor} = useStateContext()
  useEffect(() => {
  ...
  return (
    <div className='dark:bg-[#484B52]'>
      ...
      <div className="leading-normal tracking-normal text-white gradient" >
        ...
        <nav id="header" className="fixed w-full z-30 top-0 text-white dark:text-slate-100">
          <div className="w-full mx-auto flex flex-wrap items-center justify-between mt-0 py-2 bg-white  dark:bg-[#484B52]">
            ...
            <div className="block lg:hidden pr-4">
              <button onClick={() => setIsOpenMenu(!isOpenMenu)}
                id="nav-toggle" className="flex items-center p-1 text-gray-900 hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"   style= {{backgroundColor: currentColor}}>

                {isOpenMenu ? <MdClose /> : <MdMenu />}

              </button>
            </div>
            <div className={`w-full flex-grow md:flex md:items-center md:w-auto ${isOpenMenu ? "" : "hidden"} mt-2 md:mt-0 bg-white  dark:bg-[#484B52] dark:text-slate-100 text-black p-4 md:p-0 z-10" `}>
              <ul className="list-reset md:flex  flex-1 items-center ">
                <li className=" mr-96 md:mr-3  ">
                  <Link onClick={() => setIsOpenMenu(!isOpenMenu)}
                    className="inline-block  py-2 px-4 text-black dark:text-slate-100 font-bold no-underline " to="/">Home</Link>
                </li>
                <li className="mr-96 md:mr-3 ">
                  <Link onClick={() => setIsOpenMenu(!isOpenMenu)}
                    className="inline-block text-black dark:text-slate-100 no-underline hover:text-gray-900 hover:text-underline py-2 px-4" to="/">Features</Link>
                </li>
                <li className="mr-96 md:mr-3 ">
                  <Link onClick={() => setIsOpenMenu(!isOpenMenu)}
                    className="inline-block text-black dark:text-slate-100 no-underline hover:text-gray-900 hover:text-underline py-2 px-4" to="/">Resources</Link>
                </li>
               {userLogin && <li className="mr-96 md:mr-3 ">
                  <Link onClick={() => {setIsOpenMenu(!isOpenMenu);setActiveMenu(true); setShowNavBar(true)}}
                    className="inline-block text-black dark:text-slate-100 no-underline hover:text-gray-900 hover:text-underline py-2 px-4" to="/dashboard">Dashboard</Link>
                </li>}
              </ul>
              <button
                id="nav Start Free Trial"
                className="mx-auto mr-96 lg:mx-0 hover:underline  text-gray-900 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"   style= {{backgroundColor: currentColor}}
        ...
        <div className="pt-24 bg-gradient-to-r from-indigo-200  text-gray-900 dark:bg-[#484B52] dark:text-slate-100 ">
          <div className="container px-3 mx-auto flex flex-wrap  flex-col md:flex-row items-center">
            ...
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <p className="uppercase tracking-loose w-full " >Tools for For your life's work</p>
            ...
            { !userLogin && <button onClick={() => {setShowModal(true); window.scrollTo(0, 0)}}
                className="mx-auto lg:mx-0 hover:underline text-gray-900 font-bold rounded-full mt-6 mb-16 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"  style= {{backgroundColor: currentColor}}>
                Sign Up
              </button>}
            </div>
          ...
          <div className="container max-w-5xl mx-auto m-8">
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                ...
                <p className="text-gray-900  dark:text-slate-100 mb-8 text-left">
                  ...
                  <br />
                  <br />
                  A new way to execute your projects.


                </p>
              </div>
              <div className="w-full sm:w-1/2 p-6">
                <img className="w-4/6 sm:h-64 mx-auto" alt="" src={productivity}>
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <img className="w-5/6 sm:h-64 mx-auto" alt="" src={todo}>
        ...
        <section className="bg-white border-b py-8 dark:bg-[#484B52] dark:text-slate-100">
          <div className="container mx-auto flex flex-wrap pt-4 pb-12">
            <h1 className="w-full my-2 text-5xl font-bold leading-tight text-center   dark:text-slate-100  dark:text-slate-100">
              Features
            </h1>
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow dark:bg-slate-600 dark:text-slate-100">
                  <a href="/" className="flex flex-wrap no-underline hover:no-underline">
                    ...
                    <p className="text-gray-900 text-base px-6 mb-5 text-left  dark:text-slate-100">
                      Our KanBan board enables you to create tasks using beautiful cards.
                      <br />
                      <br />
                      You can track the progress of your tasks using a drag and drop functionality.
                      <br />
                      <br />
                      The Kanban board helps you remember your tasks and complete them on time.
                    </p>
                  </a>
                </div>
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6  dark:bg-slate-600 dark:text-slate-100">
                  <div className="flex items-center justify-start">
                    <button
                      className=" mx-auto lg:mx-0 hover:underline gradient text-black  dark:text-slate-100 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"   style= {{backgroundColor: currentColor}} >
                      Learn More
                    </button>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6  dark:bg-slate-600 dark:text-slate-100">
                  <div className="flex items-center justify-center">
                    <button
                      className="  dark:bg-slate-600 dark:text-slate-100 mx-auto lg:mx-0 hover:underline gradient font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease - in-out"   style= {{backgroundColor: currentColor}}>
                      Learn More
                    </button>
                  </div>
                </div>
              ...
              <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
                ...
                <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6  dark:bg-slate-600 dark:text-slate-100">
                  <div className="flex items-center justify-end">
                    <button
                      className=" dark:text-slate-100 mx-auto lg:mx-0 hover:underline gradient text-black font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"   style= {{backgroundColor: currentColor}} > 
                      Learn More
                    </button>
                  </div>
                </div>
        ...
        <svg className="wave-top dark:bg-[#484B52] dark:text-slate-100 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500" viewBox="0 0 1439 147" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
    ...
    {    !userLogin &&   <button onClick={() => { setShowModal(true); window.scrollTo(0, 0) }}
            className="mx-auto  hover:underline bg-white text-gray-900 font-bold rounded-full mt-6 mb-16 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"   style= {{backgroundColor: currentColor}}>
            Sign Up
          </button>}
        </section>
          ...
          <div className="container mx-auto px-8">
            <div className="w-full flex flex-col md:flex-row py-6">
              ...
              <div className="flex-1">
                <p className="uppercase text-gray-900  dark:text-slate-100 md:mb-6 ">Links</p>
                <ul className="list-reset mb-6">
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">FAQ</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Help</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Support</a>
                  </li>
                </ul>
              </div>
              <div className="flex-1">
                <p className="uppercase text-gray-900  dark:text-slate-100 md:mb-6">Legal</p>
                <ul className="list-reset mb-6">
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Terms</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Privacy</a>
                  </li>
                </ul>
              </div>
              <div className="flex-1">
                <p className="uppercase text-gray-900  dark:text-slate-100 md:mb-6">Social</p>
                <ul className="list-reset mb-6">
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Facebook</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Linkedin</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Twitter</a>
                  </li>
                </ul>
              </div>
              <div className="flex-1">
                <p className="uppercase text-gray-900  dark:text-slate-100 md:mb-6">Company</p>
                <ul className="list-reset mb-6">
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Official Blog</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">About Us</a>
                  </li>
                  <li className="mt-2 inline-block mr-2 md:block md:mr-0">
                    <a href="/" className="no-underline hover:underline text-gray-900  dark:text-slate-100 hover:text-pink-500">Contact</a>
                  </li>
                </ul>
              </div>
            </div>
