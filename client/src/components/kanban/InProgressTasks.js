...
const isActive= isOver && canDrop
  ...
  return (
    <div className={isActive? "bg-gradient-to-r from-orange-400 via-amber-50 to-yellow-400 kanban-block shadow-2xl" : "bg-gradient-to-r from-orange-200 via-amber-50 to-yellow-200 kanban-block shadow-md" } ref= {drop}>
        {children}
    </div>
  )
}
