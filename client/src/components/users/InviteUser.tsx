...
import { isShowModalReset, User } from "../../redux/usersSlices";
import { appDispatch } from "../../redux/Hooks";
import { useCreateTeamMemberMutation } from "../../redux/usersApiSlices";
...
function InviteUser() {
  ...
  const addMemberHandler = (values: User) => {
createTeamMember(values)
  ...
  const formik = useFormik({
    ...
    onSubmit: (values: User) => addMemberHandler(values),
  });
