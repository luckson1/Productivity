...
function CreateComment({bugId}) {
    ...
    return (<>
        ...
        <form onSubmit={formik.handleSubmit} className=" dark:bg-[#484B52] flex flex-row px-0 ">
            ...
            <div className="flex flex-row justify-between gap-2 border-1 border-slate-50 items-end" style={{width: "100%"}}>
                <textarea className=" shadow-2xl rounded-md px-1 text-xs bg-white h-24"
                    type="text"
                    id="name"
                ...
                <button type="submit" className='  rounded-md shadow-2xl h-10 animate-bounce text-white'  style={{backgroundColor: currentColor}} >
                     Add Comment
                     </button>
